========================================================================
    BIBLIOTHÈQUE DE LIENS DYNAMIQUES : Vue d'ensemble du projet DisableGhostWindows
========================================================================

AppWizard a créé cette DLL DisableGhostWindows pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application DisableGhostWindows.


DisableGhostWindows.vcxproj
...
DisableGhostWindows.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) DisableGhostWindows.pch et un fichier de type précompilé nommé StdAfx.obj.
